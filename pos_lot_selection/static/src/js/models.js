            ...
            session.rpc("/web/dataset/search_read", {
                ...
                if (result.length) {
                    for (var i = 0; i < result.length; i++) {
                        //console.log(result.records[i].quantity)
        ...
        compute_lot_lines: function(){
            ...
            this.pos.get_lot(this.product.id, this.pos.config.stock_location_id[0])
                .then(function (product_lot) {
                    ...
                    //obtener cantidad de los lotes
                    var lot_values = Object.values(product_lot);
                    ...
                    compute_lot_lines.lot_values = lot_values;

                    done.resolve(compute_lot_lines);
                });
            //console.log(compute_lot_lines)
